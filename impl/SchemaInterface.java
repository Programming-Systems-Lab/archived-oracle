...
{
    String[] moduleInfo = {"default,false,","default,false,","default,false,"};
    String defaultModuleInfo = "default,false,";
        ...
        for (int i=0; i<3; i++)
        {
            if(st.hasMoreElements())
            {
                ...
                if (i==2)
                {
                    ...
                    {
                        System.out.println(totalElements+" "+actualElements);
